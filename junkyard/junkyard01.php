...
<html>
<head>
<title>Iconic NPC Junkyard Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_junkyard.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_junkyard_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Junkyard Character Constructor
	*/
	function Character() {
    ...
    let rover = getJunkyard();
     ...
     /*getJunkyard() return the statistics for the rover per level*/  
    function getJunkyard() {
	var rover = [
	...
	return rover[0]; 
       ...
       let imgData = "images/junkyard_character_sheet.png";
