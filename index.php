...
<html>
<head>
<title>Launch Page: Junkyard Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="junkyardForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level2" class="dropdownmenu2Iconic">
				<option value="01" selected>Junkyard, Level 1</option>
				<option value="02">Junkyard, Level 2</option>
				<option value="03">Junkyard, Level 3</option>
				<option value="04">Junkyard, Level 4</option>
				<option value="05">Junkyard, Level 5</option>
				<option value="06">Junkyard, Level 6</option>
				<option value="07">Junkyard, Level 7</option>
				<option value="08">Junkyard, Level 8</option>
				<option value="09">Junkyard, Level 9</option>
				<option value="10">Junkyard, Level 10</option>
			  </select>
        ...
        {
            $("#junkyardForm").attr('action', "junkyard/junkyard"+ $("#level2").val() +  ".php");
        });
